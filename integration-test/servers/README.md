...
Remember:
1. Replace the full-path to the servers JAR with the correct path on your system
...
#### In MCP Inspector
(Remember to use the full-path to the servers JAR on your system, or execute this command from the `mcp-clojure-sdk` repo)
